...
if __name__=="__main__":
    ...
    with open(data_dir+'/wav.scp','w') as fw, open(data_dir+'/utt2spk','w') as ft,open(data_dir+'/text','w') as fu:
        for i,k in enumerate(flist):
            ...
            fw.write("{}_{}_{}_{} {}/ex_{}/s1_estimate.wav\n".format(spk1[0:3],i+offset,spk1,spk2,wav_dir,i))
            fw.write("{}_{}_{}_{} {}/ex_{}/s2_estimate.wav\n".format(spk2[0:3],i+offset,spk1,spk2,wav_dir,i))
